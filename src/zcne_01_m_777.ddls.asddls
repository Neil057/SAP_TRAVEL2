...
define root view entity zcne_01_m_777
  as projection on ZINE_01_M_777
{
      @UI.facet: [ { id:              'Travel',
                     purpose:         #STANDARD,
  ...
  key mykey              as TravelUUID,
      ...
      @Consumption.valueHelpDefinition: [{ entity : {name: 'ZOD_I_Agency', element: 'AgencyID'  } }]
      ...
      @Consumption.valueHelpDefinition: [{ entity : {name: 'ZOD_I_Customer', element: 'CustomerID'  } }]
